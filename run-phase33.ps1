# ============================================================================
# Phase 33 - 101 Videos (8 Nuts & Seeds + 30 Oceans & Seas + 30 Office Supplies + 30 Painting Styles + 3 Park Things)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase33.ps1
# ============================================================================
...
Write-Host "  PHASE 33: 8 Nuts & Seeds + 30 Oceans & Seas + 30 Office Supplies + 30 Painting Styles + 3 Park Things" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "nuts-seeds\catalog.json"; Name = "Nuts & Seeds"; From = 22; To = 30 },
    @{ Path = "oceans\catalog.json"; Name = "Oceans & Seas"; From = 0; To = 30 },
    @{ Path = "office-supplies\catalog.json"; Name = "Office Supplies"; From = 0; To = 30 },
    @{ Path = "painting-styles\catalog.json"; Name = "Painting Styles"; From = 0; To = 30 },
    @{ Path = "park-things\catalog.json"; Name = "Park Things"; From = 0; To = 3 }
)
...
node (Join-Path $ProjectDir "nuts-seeds\register-compositions.js")
node (Join-Path $ProjectDir "oceans\register-compositions.js")
node (Join-Path $ProjectDir "office-supplies\register-compositions.js")
node (Join-Path $ProjectDir "painting-styles\register-compositions.js")
node (Join-Path $ProjectDir "park-things\register-compositions.js")
...
Write-Host "  PHASE 33 COMPLETE!" -ForegroundColor Green
