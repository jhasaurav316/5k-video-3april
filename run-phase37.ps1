# ============================================================================
# Phase 37 - 101 Videos (24 Reptiles + 30 Rivers & Lakes + 30 Robots & Machines + 17 Rocks & Minerals)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase37.ps1
# ============================================================================
...
Write-Host "  PHASE 37: 24 Reptiles + 30 Rivers & Lakes + 30 Robots & Machines + 17 Rocks & Minerals" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "reptiles\catalog.json"; Name = "Reptiles"; From = 6; To = 30 },
    @{ Path = "rivers\catalog.json"; Name = "Rivers & Lakes"; From = 0; To = 30 },
    @{ Path = "robots\catalog.json"; Name = "Robots & Machines"; From = 0; To = 30 },
    @{ Path = "rocks-minerals\catalog.json"; Name = "Rocks & Minerals"; From = 0; To = 17 }
)
...
node (Join-Path $ProjectDir "rivers\register-compositions.js")
node (Join-Path $ProjectDir "robots\register-compositions.js")
...
Write-Host "  PHASE 37 COMPLETE!" -ForegroundColor Green
