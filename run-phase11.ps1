# ============================================================================
# Phase 11 - 101 Videos (10 Clothing Items + 30 Colors + 30 Community Helpers + 30 Computer Words + 1 Construction Vehicles)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase11.ps1
# ============================================================================
...
Write-Host "  PHASE 11: 10 Clothing Items + 30 Colors + 30 Community Helpers + 30 Computer Words + 1 Construction Vehicles" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "clothing-items\catalog.json"; Name = "Clothing Items"; From = 20; To = 30 },
    @{ Path = "colors\catalog.json"; Name = "Colors"; From = 0; To = 30 },
    @{ Path = "community-helpers\catalog.json"; Name = "Community Helpers"; From = 0; To = 30 },
    @{ Path = "computer-words\catalog.json"; Name = "Computer Words"; From = 0; To = 30 },
    @{ Path = "construction-vehicles\catalog.json"; Name = "Construction Vehicles"; From = 0; To = 1 }
)
...
node (Join-Path $ProjectDir "clothing-items\register-compositions.js")
node (Join-Path $ProjectDir "colors\register-compositions.js")
node (Join-Path $ProjectDir "community-helpers\register-compositions.js")
node (Join-Path $ProjectDir "computer-words\register-compositions.js")
node (Join-Path $ProjectDir "construction-vehicles\register-compositions.js")
