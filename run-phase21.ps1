# ============================================================================
# Phase 21 - 101 Videos (20 Five Senses + 30 Flying Machines + 30 Forest Animals + 21 Fruits)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase21.ps1
# ============================================================================
...
Write-Host "  PHASE 21: 20 Five Senses + 30 Flying Machines + 30 Forest Animals + 21 Fruits" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "five-senses\catalog.json"; Name = "Five Senses"; From = 10; To = 30 },
    @{ Path = "flying-machines\catalog.json"; Name = "Flying Machines"; From = 0; To = 30 },
    @{ Path = "forest-animals\catalog.json"; Name = "Forest Animals"; From = 0; To = 30 },
    @{ Path = "fruits\catalog.json"; Name = "Fruits"; From = 0; To = 21 }
)
...
node (Join-Path $ProjectDir "flying-machines\register-compositions.js")
...
Write-Host "  PHASE 21 COMPLETE!" -ForegroundColor Green
