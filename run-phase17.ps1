# ============================================================================
# Phase 17 - 101 Videos (4 Endangered Species + 30 Energy Types + 30 Exercise Moves + 30 Fabrics & Textiles + 7 Fairy Creatures)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase17.ps1
# ============================================================================
...
Write-Host "  PHASE 17: 4 Endangered Species + 30 Energy Types + 30 Exercise Moves + 30 Fabrics & Textiles + 7 Fairy Creatures" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "endangered-species\catalog.json"; Name = "Endangered Species"; From = 26; To = 30 },
    @{ Path = "energy-types\catalog.json"; Name = "Energy Types"; From = 0; To = 30 },
    @{ Path = "exercise-moves\catalog.json"; Name = "Exercise Moves"; From = 0; To = 30 },
    @{ Path = "fabrics\catalog.json"; Name = "Fabrics & Textiles"; From = 0; To = 30 },
    @{ Path = "fairy-creatures\catalog.json"; Name = "Fairy Creatures"; From = 0; To = 7 }
)
...
node (Join-Path $ProjectDir "endangered-species\register-compositions.js")
node (Join-Path $ProjectDir "energy-types\register-compositions.js")
node (Join-Path $ProjectDir "exercise-moves\register-compositions.js")
node (Join-Path $ProjectDir "fabrics\register-compositions.js")
node (Join-Path $ProjectDir "fairy-creatures\register-compositions.js")
