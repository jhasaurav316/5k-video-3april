# ============================================================================
# Phase 36 - 101 Videos (5 Pond Life + 30 Pottery Words + 30 Rainforest + 30 Reading Words + 6 Reptiles)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase36.ps1
# ============================================================================
...
Write-Host "  PHASE 36: 5 Pond Life + 30 Pottery Words + 30 Rainforest + 30 Reading Words + 6 Reptiles" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "pond-life\catalog.json"; Name = "Pond Life"; From = 25; To = 30 },
    @{ Path = "pottery-words\catalog.json"; Name = "Pottery Words"; From = 0; To = 30 },
    @{ Path = "rainforest\catalog.json"; Name = "Rainforest"; From = 0; To = 30 },
    @{ Path = "reading-words\catalog.json"; Name = "Reading Words"; From = 0; To = 30 },
    @{ Path = "reptiles\catalog.json"; Name = "Reptiles"; From = 0; To = 6 }
)
...
node (Join-Path $ProjectDir "pond-life\register-compositions.js")
node (Join-Path $ProjectDir "pottery-words\register-compositions.js")
node (Join-Path $ProjectDir "rainforest\register-compositions.js")
node (Join-Path $ProjectDir "reading-words\register-compositions.js")
node (Join-Path $ProjectDir "reptiles\register-compositions.js")
...
Write-Host "  PHASE 36 COMPLETE!" -ForegroundColor Green
