# ============================================================================
# Phase 29 - 101 Videos (22 Living Room Items + 30 Magnets + 30 Martial Arts + 19 Math Words)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase29.ps1
# ============================================================================
...
Write-Host "  PHASE 29: 22 Living Room Items + 30 Magnets + 30 Martial Arts + 19 Math Words" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "living-room\catalog.json"; Name = "Living Room Items"; From = 8; To = 30 },
    @{ Path = "magnets\catalog.json"; Name = "Magnets"; From = 0; To = 30 },
    @{ Path = "martial-arts\catalog.json"; Name = "Martial Arts"; From = 0; To = 30 },
    @{ Path = "math-words\catalog.json"; Name = "Math Words"; From = 0; To = 19 }
)
...
node (Join-Path $ProjectDir "magnets\register-compositions.js")
node (Join-Path $ProjectDir "martial-arts\register-compositions.js")
...
Write-Host "  PHASE 29 COMPLETE!" -ForegroundColor Green
