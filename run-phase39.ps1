# ============================================================================
# Phase 39 - 101 Videos (2 Savanna Animals + 30 School Items + 30 Science Careers + 30 Science Lab + 9 Science Words)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase39.ps1
# ============================================================================
...
Write-Host "  PHASE 39: 2 Savanna Animals + 30 School Items + 30 Science Careers + 30 Science Lab + 9 Science Words" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "savanna-animals\catalog.json"; Name = "Savanna Animals"; From = 28; To = 30 },
    @{ Path = "school-items\catalog.json"; Name = "School Items"; From = 0; To = 30 },
    @{ Path = "science-careers\catalog.json"; Name = "Science Careers"; From = 0; To = 30 },
    @{ Path = "science-lab\catalog.json"; Name = "Science Lab"; From = 0; To = 30 },
    @{ Path = "science-words\catalog.json"; Name = "Science Words"; From = 0; To = 9 }
)
...
node (Join-Path $ProjectDir "savanna-animals\register-compositions.js")
node (Join-Path $ProjectDir "school-items\register-compositions.js")
node (Join-Path $ProjectDir "science-careers\register-compositions.js")
node (Join-Path $ProjectDir "science-lab\register-compositions.js")
node (Join-Path $ProjectDir "science-words\register-compositions.js")
...
Write-Host "  PHASE 39 COMPLETE!" -ForegroundColor Green
