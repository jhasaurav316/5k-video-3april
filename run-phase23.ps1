# ============================================================================
# Phase 23 - 101 Videos (28 Garden Items + 30 Gardening Tools + 30 Gemstones & Crystals + 13 Grains & Cereals)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase23.ps1
# ============================================================================
...
Write-Host "  PHASE 23: 28 Garden Items + 30 Gardening Tools + 30 Gemstones & Crystals + 13 Grains & Cereals" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "garden-items\catalog.json"; Name = "Garden Items"; From = 2; To = 30 },
    @{ Path = "gardening-tools\catalog.json"; Name = "Gardening Tools"; From = 0; To = 30 },
    @{ Path = "gemstones\catalog.json"; Name = "Gemstones & Crystals"; From = 0; To = 30 },
    @{ Path = "grains-cereals\catalog.json"; Name = "Grains & Cereals"; From = 0; To = 13 }
)
...
node (Join-Path $ProjectDir "gardening-tools\register-compositions.js")
node (Join-Path $ProjectDir "gemstones\register-compositions.js")
node (Join-Path $ProjectDir "grains-cereals\register-compositions.js")
...
Write-Host "  PHASE 23 COMPLETE!" -ForegroundColor Green
