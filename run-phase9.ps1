# ============================================================================
# Phase 9 - 101 Videos (2 Carnival & Circus + 30 Cartoon Characters + 30 Cheese Types + 30 Christmas + 9 City Places)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase9.ps1
# ============================================================================
...
Write-Host "  PHASE 9: 2 Carnival & Circus + 30 Cartoon Characters + 30 Cheese Types + 30 Christmas + 9 City Places" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "carnival-circus\catalog.json"; Name = "Carnival & Circus"; From = 28; To = 30 },
    @{ Path = "cartoon-characters\catalog.json"; Name = "Cartoon Characters"; From = 0; To = 30 },
    @{ Path = "cheese\catalog.json"; Name = "Cheese Types"; From = 0; To = 30 },
    @{ Path = "christmas\catalog.json"; Name = "Christmas"; From = 0; To = 30 },
    @{ Path = "city-places\catalog.json"; Name = "City Places"; From = 0; To = 9 }
)
...
node (Join-Path $ProjectDir "carnival-circus\register-compositions.js")
node (Join-Path $ProjectDir "cartoon-characters\register-compositions.js")
node (Join-Path $ProjectDir "cheese\register-compositions.js")
node (Join-Path $ProjectDir "christmas\register-compositions.js")
node (Join-Path $ProjectDir "city-places\register-compositions.js")
