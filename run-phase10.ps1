# ============================================================================
# Phase 10 - 101 Videos (21 City Places + 30 Classroom Objects + 30 Cleaning Items + 20 Clothing Items)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase10.ps1
# ============================================================================
...
Write-Host "  PHASE 10: 21 City Places + 30 Classroom Objects + 30 Cleaning Items + 20 Clothing Items" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "city-places\catalog.json"; Name = "City Places"; From = 9; To = 30 },
    @{ Path = "classroom-objects\catalog.json"; Name = "Classroom Objects"; From = 0; To = 30 },
    @{ Path = "cleaning-items\catalog.json"; Name = "Cleaning Items"; From = 0; To = 30 },
    @{ Path = "clothing-items\catalog.json"; Name = "Clothing Items"; From = 0; To = 20 }
)
...
node (Join-Path $ProjectDir "classroom-objects\register-compositions.js")
node (Join-Path $ProjectDir "cleaning-items\register-compositions.js")
