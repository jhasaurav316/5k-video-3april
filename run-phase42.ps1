# ============================================================================
# Phase 42 - 101 Videos (29 Space Objects + 30 Spices & Herbs + 30 Sports Careers + 12 Sports Equipment)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase42.ps1
# ============================================================================
...
Write-Host "  PHASE 42: 29 Space Objects + 30 Spices & Herbs + 30 Sports Careers + 12 Sports Equipment" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "space-objects\catalog.json"; Name = "Space Objects"; From = 1; To = 30 },
    @{ Path = "spices\catalog.json"; Name = "Spices & Herbs"; From = 0; To = 30 },
    @{ Path = "sports-careers\catalog.json"; Name = "Sports Careers"; From = 0; To = 30 },
    @{ Path = "sports-equipment\catalog.json"; Name = "Sports Equipment"; From = 0; To = 12 }
)
...
node (Join-Path $ProjectDir "spices\register-compositions.js")
node (Join-Path $ProjectDir "sports-careers\register-compositions.js")
...
Write-Host "  PHASE 42 COMPLETE!" -ForegroundColor Green
