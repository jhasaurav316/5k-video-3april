# ============================================================================
# Phase 47 - 101 Videos (4 Types of Houses + 30 Types of Music + 30 Types of Trains + 30 Types of Trees + 7 Underwater World)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase47.ps1
# ============================================================================
...
Write-Host "  PHASE 47: 4 Types of Houses + 30 Types of Music + 30 Types of Trains + 30 Types of Trees + 7 Underwater World" -ForegroundColor Cyan
Write-Host "  101 Videos | Using $cpuCores CPU cores | Full HD (1080x1920)" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
$catalogs = @(
    @{ Path = "types-of-houses\catalog.json"; Name = "Types of Houses"; From = 26; To = 30 },
    @{ Path = "types-of-music\catalog.json"; Name = "Types of Music"; From = 0; To = 30 },
    @{ Path = "types-of-trains\catalog.json"; Name = "Types of Trains"; From = 0; To = 30 },
    @{ Path = "types-of-trees\catalog.json"; Name = "Types of Trees"; From = 0; To = 30 },
    @{ Path = "underwater\catalog.json"; Name = "Underwater World"; From = 0; To = 7 }
)
...
node (Join-Path $ProjectDir "types-of-houses\register-compositions.js")
node (Join-Path $ProjectDir "types-of-music\register-compositions.js")
node (Join-Path $ProjectDir "types-of-trains\register-compositions.js")
node (Join-Path $ProjectDir "types-of-trees\register-compositions.js")
node (Join-Path $ProjectDir "underwater\register-compositions.js")
...
Write-Host "  PHASE 47 COMPLETE!" -ForegroundColor Green
