# ============================================================================
# Phase 6 - 101 Videos (5 Birds of Prey + 30 Birthday Party + 30 Board Games + 30 Body Parts + 6 Breads of the World)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase6.ps1
# ============================================================================
...
Write-Host "  PHASE 6: 5 Birds of Prey + 30 Birthday Party + 30 Board Games + 30 Body Parts + 6 Breads of the World" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "birds-of-prey\catalog.json"; Name = "Birds of Prey"; From = 25; To = 30 },
    @{ Path = "birthday-party\catalog.json"; Name = "Birthday Party"; From = 0; To = 30 },
    @{ Path = "board-games\catalog.json"; Name = "Board Games"; From = 0; To = 30 },
    @{ Path = "body-parts\catalog.json"; Name = "Body Parts"; From = 0; To = 30 },
    @{ Path = "breads\catalog.json"; Name = "Breads of the World"; From = 0; To = 6 }
)
...
node (Join-Path $ProjectDir "birds-of-prey\register-compositions.js")
node (Join-Path $ProjectDir "birthday-party\register-compositions.js")
node (Join-Path $ProjectDir "board-games\register-compositions.js")
node (Join-Path $ProjectDir "body-parts\register-compositions.js")
node (Join-Path $ProjectDir "breads\register-compositions.js")
