# ============================================================================
# Phase 26 - 101 Videos (25 Ice Cream Flavors + 30 Insects & Bugs + 30 Island Things + 16 Jewelry)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase26.ps1
# ============================================================================
...
Write-Host "  PHASE 26: 25 Ice Cream Flavors + 30 Insects & Bugs + 30 Island Things + 16 Jewelry" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "ice-cream-flavors\catalog.json"; Name = "Ice Cream Flavors"; From = 5; To = 30 },
    @{ Path = "insects-bugs\catalog.json"; Name = "Insects & Bugs"; From = 0; To = 30 },
    @{ Path = "island-things\catalog.json"; Name = "Island Things"; From = 0; To = 30 },
    @{ Path = "jewelry\catalog.json"; Name = "Jewelry"; From = 0; To = 16 }
)
...
node (Join-Path $ProjectDir "insects-bugs\register-compositions.js")
node (Join-Path $ProjectDir "island-things\register-compositions.js")
node (Join-Path $ProjectDir "jewelry\register-compositions.js")
...
Write-Host "  PHASE 26 COMPLETE!" -ForegroundColor Green
