# ============================================================================
# Phase 50 - 61 Videos (1 Winter Clothing + 30 Winter Words + 30 Zoo Animals)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase50.ps1
# ============================================================================
...
$catalogs = @(
    @{ Path = "winter-clothing\catalog.json"; Name = "Winter Clothing"; From = 29; To = 30 },
...
node (Join-Path $ProjectDir "winter-words\register-compositions.js")
node (Join-Path $ProjectDir "zoo-animals\register-compositions.js")
...
Write-Host "  STEP 3: Rendering 61 Videos (2:00-2:50 each)" -ForegroundColor Yellow
Write-Host ""
...
Write-Host "  PHASE 50 COMPLETE!" -ForegroundColor Green
