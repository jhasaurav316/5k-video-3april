# ============================================================================
# Phase 28 - 101 Videos (3 Kitchen Tools + 30 World Languages + 30 Laundry Items + 30 Library Words + 8 Living Room Items)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase28.ps1
# ============================================================================
...
Write-Host "  PHASE 28: 3 Kitchen Tools + 30 World Languages + 30 Laundry Items + 30 Library Words + 8 Living Room Items" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "kitchen-tools\catalog.json"; Name = "Kitchen Tools"; From = 27; To = 30 },
    @{ Path = "languages\catalog.json"; Name = "World Languages"; From = 0; To = 30 },
    @{ Path = "laundry-items\catalog.json"; Name = "Laundry Items"; From = 0; To = 30 },
    @{ Path = "library-words\catalog.json"; Name = "Library Words"; From = 0; To = 30 },
    @{ Path = "living-room\catalog.json"; Name = "Living Room Items"; From = 0; To = 8 }
)
...
node (Join-Path $ProjectDir "kitchen-tools\register-compositions.js")
node (Join-Path $ProjectDir "languages\register-compositions.js")
node (Join-Path $ProjectDir "laundry-items\register-compositions.js")
node (Join-Path $ProjectDir "library-words\register-compositions.js")
node (Join-Path $ProjectDir "living-room\register-compositions.js")
...
Write-Host "  PHASE 28 COMPLETE!" -ForegroundColor Green
