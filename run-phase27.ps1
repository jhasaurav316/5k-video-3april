# ============================================================================
# Phase 27 - 101 Videos (14 Jewelry + 30 Jungle Animals + 30 Kitchen Appliances + 27 Kitchen Tools)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase27.ps1
# ============================================================================
...
Write-Host "  PHASE 27: 14 Jewelry + 30 Jungle Animals + 30 Kitchen Appliances + 27 Kitchen Tools" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "jewelry\catalog.json"; Name = "Jewelry"; From = 16; To = 30 },
    @{ Path = "jungle-animals\catalog.json"; Name = "Jungle Animals"; From = 0; To = 30 },
    @{ Path = "kitchen-appliances\catalog.json"; Name = "Kitchen Appliances"; From = 0; To = 30 },
    @{ Path = "kitchen-tools\catalog.json"; Name = "Kitchen Tools"; From = 0; To = 27 }
)
...
node (Join-Path $ProjectDir "jungle-animals\register-compositions.js")
node (Join-Path $ProjectDir "kitchen-appliances\register-compositions.js")
...
Write-Host "  PHASE 27 COMPLETE!" -ForegroundColor Green
