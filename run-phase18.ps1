# ============================================================================
# Phase 18 - 101 Videos (23 Fairy Creatures + 30 Fairy Tales + 30 Family Members + 18 Famous Landmarks)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase18.ps1
# ============================================================================
...
Write-Host "  PHASE 18: 23 Fairy Creatures + 30 Fairy Tales + 30 Family Members + 18 Famous Landmarks" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "fairy-creatures\catalog.json"; Name = "Fairy Creatures"; From = 7; To = 30 },
    @{ Path = "fairy-tales\catalog.json"; Name = "Fairy Tales"; From = 0; To = 30 },
    @{ Path = "family-members\catalog.json"; Name = "Family Members"; From = 0; To = 30 },
    @{ Path = "famous-landmarks\catalog.json"; Name = "Famous Landmarks"; From = 0; To = 18 }
)
...
node (Join-Path $ProjectDir "fairy-tales\register-compositions.js")
node (Join-Path $ProjectDir "family-members\register-compositions.js")
node (Join-Path $ProjectDir "famous-landmarks\register-compositions.js")
