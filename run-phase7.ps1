# ============================================================================
# Phase 7 - 101 Videos (24 Breads of the World + 30 Breakfast Foods + 30 Buildings + 17 Butterflies & Moths)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase7.ps1
# ============================================================================
...
Write-Host "  PHASE 7: 24 Breads of the World + 30 Breakfast Foods + 30 Buildings + 17 Butterflies & Moths" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "breads\catalog.json"; Name = "Breads of the World"; From = 6; To = 30 },
    @{ Path = "breakfast-foods\catalog.json"; Name = "Breakfast Foods"; From = 0; To = 30 },
    @{ Path = "buildings\catalog.json"; Name = "Buildings"; From = 0; To = 30 },
    @{ Path = "butterflies\catalog.json"; Name = "Butterflies & Moths"; From = 0; To = 17 }
)
...
node (Join-Path $ProjectDir "breakfast-foods\register-compositions.js")
node (Join-Path $ProjectDir "buildings\register-compositions.js")
