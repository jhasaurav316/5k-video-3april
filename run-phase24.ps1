# ============================================================================
# Phase 24 - 101 Videos (17 Grains & Cereals + 30 Halloween + 30 Hats & Caps + 24 Healthy Habits)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase24.ps1
# ============================================================================
...
Write-Host "  PHASE 24: 17 Grains & Cereals + 30 Halloween + 30 Hats & Caps + 24 Healthy Habits" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "grains-cereals\catalog.json"; Name = "Grains & Cereals"; From = 13; To = 30 },
    @{ Path = "halloween\catalog.json"; Name = "Halloween"; From = 0; To = 30 },
    @{ Path = "hats-caps\catalog.json"; Name = "Hats & Caps"; From = 0; To = 30 },
    @{ Path = "healthy-habits\catalog.json"; Name = "Healthy Habits"; From = 0; To = 24 }
)
...
node (Join-Path $ProjectDir "halloween\register-compositions.js")
node (Join-Path $ProjectDir "hats-caps\register-compositions.js")
...
Write-Host "  PHASE 24 COMPLETE!" -ForegroundColor Green
