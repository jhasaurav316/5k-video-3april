# ============================================================================
# Phase 25 - 101 Videos (6 Healthy Habits + 30 Herbs + 30 Hiking Words + 30 Hospital & Medical + 5 Ice Cream Flavors)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase25.ps1
# ============================================================================
...
Write-Host "  PHASE 25: 6 Healthy Habits + 30 Herbs + 30 Hiking Words + 30 Hospital & Medical + 5 Ice Cream Flavors" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "healthy-habits\catalog.json"; Name = "Healthy Habits"; From = 24; To = 30 },
    @{ Path = "herbs\catalog.json"; Name = "Herbs"; From = 0; To = 30 },
    @{ Path = "hiking-words\catalog.json"; Name = "Hiking Words"; From = 0; To = 30 },
    @{ Path = "hospital\catalog.json"; Name = "Hospital & Medical"; From = 0; To = 30 },
    @{ Path = "ice-cream-flavors\catalog.json"; Name = "Ice Cream Flavors"; From = 0; To = 5 }
)
...
node (Join-Path $ProjectDir "healthy-habits\register-compositions.js")
node (Join-Path $ProjectDir "herbs\register-compositions.js")
node (Join-Path $ProjectDir "hiking-words\register-compositions.js")
node (Join-Path $ProjectDir "hospital\register-compositions.js")
node (Join-Path $ProjectDir "ice-cream-flavors\register-compositions.js")
...
Write-Host "  PHASE 25 COMPLETE!" -ForegroundColor Green
