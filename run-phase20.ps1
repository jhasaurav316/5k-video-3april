# ============================================================================
# Phase 20 - 101 Videos (1 Farm Things + 30 Farm Vehicles + 30 World Festivals + 30 Fishing Words + 10 Five Senses)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase20.ps1
# ============================================================================
...
Write-Host "  PHASE 20: 1 Farm Things + 30 Farm Vehicles + 30 World Festivals + 30 Fishing Words + 10 Five Senses" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "farm-things\catalog.json"; Name = "Farm Things"; From = 29; To = 30 },
    @{ Path = "farm-vehicles\catalog.json"; Name = "Farm Vehicles"; From = 0; To = 30 },
    @{ Path = "festivals\catalog.json"; Name = "World Festivals"; From = 0; To = 30 },
    @{ Path = "fishing-words\catalog.json"; Name = "Fishing Words"; From = 0; To = 30 },
    @{ Path = "five-senses\catalog.json"; Name = "Five Senses"; From = 0; To = 10 }
)
...
node (Join-Path $ProjectDir "farm-things\register-compositions.js")
node (Join-Path $ProjectDir "farm-vehicles\register-compositions.js")
node (Join-Path $ProjectDir "festivals\register-compositions.js")
node (Join-Path $ProjectDir "fishing-words\register-compositions.js")
node (Join-Path $ProjectDir "five-senses\register-compositions.js")
