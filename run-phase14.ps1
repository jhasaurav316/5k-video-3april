# ============================================================================
# Phase 14 - 101 Videos (7 Dance Styles + 30 Days of the Week + 30 Dental Care + 30 Desert Things + 4 Dessert Types)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase14.ps1
# ============================================================================
...
Write-Host "  PHASE 14: 7 Dance Styles + 30 Days of the Week + 30 Dental Care + 30 Desert Things + 4 Dessert Types" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "dance-styles\catalog.json"; Name = "Dance Styles"; From = 23; To = 30 },
    @{ Path = "days-of-week\catalog.json"; Name = "Days of the Week"; From = 0; To = 30 },
    @{ Path = "dental-care\catalog.json"; Name = "Dental Care"; From = 0; To = 30 },
    @{ Path = "desert-things\catalog.json"; Name = "Desert Things"; From = 0; To = 30 },
    @{ Path = "dessert-types\catalog.json"; Name = "Dessert Types"; From = 0; To = 4 }
)
...
node (Join-Path $ProjectDir "dance-styles\register-compositions.js")
node (Join-Path $ProjectDir "days-of-week\register-compositions.js")
node (Join-Path $ProjectDir "dental-care\register-compositions.js")
node (Join-Path $ProjectDir "desert-things\register-compositions.js")
node (Join-Path $ProjectDir "dessert-types\register-compositions.js")
