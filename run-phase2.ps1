# ============================================================================
# Phase 2 - 101 Videos (19 Animal Sounds + 30 Arctic Animals + 30 Art Supplies + 22 Autumn Words)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase2.ps1
# ============================================================================
...
Write-Host "  PHASE 2: 19 Animal Sounds + 30 Arctic Animals + 30 Art Supplies + 22 Autumn Words" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "animal-sounds\catalog.json"; Name = "Animal Sounds"; From = 11; To = 30 },
    @{ Path = "arctic-animals\catalog.json"; Name = "Arctic Animals"; From = 0; To = 30 },
    @{ Path = "art-supplies\catalog.json"; Name = "Art Supplies"; From = 0; To = 30 },
    @{ Path = "autumn-words\catalog.json"; Name = "Autumn Words"; From = 0; To = 22 }
)
...
node (Join-Path $ProjectDir "arctic-animals\register-compositions.js")
node (Join-Path $ProjectDir "art-supplies\register-compositions.js")
