# ============================================================================
# Phase 38 - 101 Videos (13 Rocks & Minerals + 30 Salad Items + 30 Sandwiches + 28 Savanna Animals)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase38.ps1
# ============================================================================
...
Write-Host "  PHASE 38: 13 Rocks & Minerals + 30 Salad Items + 30 Sandwiches + 28 Savanna Animals" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "rocks-minerals\catalog.json"; Name = "Rocks & Minerals"; From = 17; To = 30 },
    @{ Path = "salad-items\catalog.json"; Name = "Salad Items"; From = 0; To = 30 },
    @{ Path = "sandwiches\catalog.json"; Name = "Sandwiches"; From = 0; To = 30 },
    @{ Path = "savanna-animals\catalog.json"; Name = "Savanna Animals"; From = 0; To = 28 }
)
...
node (Join-Path $ProjectDir "rocks-minerals\register-compositions.js")
node (Join-Path $ProjectDir "salad-items\register-compositions.js")
node (Join-Path $ProjectDir "sandwiches\register-compositions.js")
...
Write-Host "  PHASE 38 COMPLETE!" -ForegroundColor Green
