# ============================================================================
# Phase 48 - 101 Videos (23 Underwater World + 30 Vegetables + 30 Vehicles + 18 Video Games)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase48.ps1
# ============================================================================
...
Write-Host "  PHASE 48: 23 Underwater World + 30 Vegetables + 30 Vehicles + 18 Video Games" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "underwater\catalog.json"; Name = "Underwater World"; From = 7; To = 30 },
    @{ Path = "vegetables\catalog.json"; Name = "Vegetables"; From = 0; To = 30 },
    @{ Path = "vehicles\catalog.json"; Name = "Vehicles"; From = 0; To = 30 },
    @{ Path = "video-games\catalog.json"; Name = "Video Games"; From = 0; To = 18 }
)
...
node (Join-Path $ProjectDir "vegetables\register-compositions.js")
node (Join-Path $ProjectDir "vehicles\register-compositions.js")
node (Join-Path $ProjectDir "video-games\register-compositions.js")
...
Write-Host "  PHASE 48 COMPLETE!" -ForegroundColor Green
