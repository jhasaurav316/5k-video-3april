# ============================================================================
# Phase 8 - 101 Videos (13 Butterflies & Moths + 30 Camping & Outdoors + 30 Candy & Sweets + 28 Carnival & Circus)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase8.ps1
# ============================================================================
...
Write-Host "  PHASE 8: 13 Butterflies & Moths + 30 Camping & Outdoors + 30 Candy & Sweets + 28 Carnival & Circus" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "butterflies\catalog.json"; Name = "Butterflies & Moths"; From = 17; To = 30 },
    @{ Path = "camping\catalog.json"; Name = "Camping & Outdoors"; From = 0; To = 30 },
    @{ Path = "candy\catalog.json"; Name = "Candy & Sweets"; From = 0; To = 30 },
    @{ Path = "carnival-circus\catalog.json"; Name = "Carnival & Circus"; From = 0; To = 28 }
)
...
node (Join-Path $ProjectDir "butterflies\register-compositions.js")
node (Join-Path $ProjectDir "camping\register-compositions.js")
node (Join-Path $ProjectDir "candy\register-compositions.js")
