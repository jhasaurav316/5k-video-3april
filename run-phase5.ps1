# ============================================================================
# Phase 5 - 101 Videos (16 Beach & Seaside + 30 Bedroom Items + 30 Berries + 25 Birds of Prey)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase5.ps1
# ============================================================================
...
Write-Host "  PHASE 5: 16 Beach & Seaside + 30 Bedroom Items + 30 Berries + 25 Birds of Prey" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "beach\catalog.json"; Name = "Beach & Seaside"; From = 14; To = 30 },
    @{ Path = "bedroom-items\catalog.json"; Name = "Bedroom Items"; From = 0; To = 30 },
    @{ Path = "berries\catalog.json"; Name = "Berries"; From = 0; To = 30 },
    @{ Path = "birds-of-prey\catalog.json"; Name = "Birds of Prey"; From = 0; To = 25 }
)
...
node (Join-Path $ProjectDir "beach\register-compositions.js")
node (Join-Path $ProjectDir "bedroom-items\register-compositions.js")
node (Join-Path $ProjectDir "berries\register-compositions.js")
