# ============================================================================
# Phase 35 - 101 Videos (16 Planets & Space Objects + 30 Plant Parts + 30 Playground + 25 Pond Life)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase35.ps1
# ============================================================================
...
Write-Host "  PHASE 35: 16 Planets & Space Objects + 30 Plant Parts + 30 Playground + 25 Pond Life" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "planets\catalog.json"; Name = "Planets & Space Objects"; From = 14; To = 30 },
    @{ Path = "plant-parts\catalog.json"; Name = "Plant Parts"; From = 0; To = 30 },
    @{ Path = "playground\catalog.json"; Name = "Playground"; From = 0; To = 30 },
    @{ Path = "pond-life\catalog.json"; Name = "Pond Life"; From = 0; To = 25 }
)
...
node (Join-Path $ProjectDir "plant-parts\register-compositions.js")
node (Join-Path $ProjectDir "playground\register-compositions.js")
