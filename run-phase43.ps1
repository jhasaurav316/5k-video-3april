# ============================================================================
# Phase 43 - 101 Videos (18 Sports Equipment + 30 Spring Words + 30 States of Matter + 23 Summer Words)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase43.ps1
# ============================================================================
...
Write-Host "  PHASE 43: 18 Sports Equipment + 30 Spring Words + 30 States of Matter + 23 Summer Words" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "sports-equipment\catalog.json"; Name = "Sports Equipment"; From = 12; To = 30 },
    @{ Path = "spring-words\catalog.json"; Name = "Spring Words"; From = 0; To = 30 },
    @{ Path = "states-of-matter\catalog.json"; Name = "States of Matter"; From = 0; To = 30 },
    @{ Path = "summer-words\catalog.json"; Name = "Summer Words"; From = 0; To = 23 }
)
...
node (Join-Path $ProjectDir "spring-words\register-compositions.js")
node (Join-Path $ProjectDir "states-of-matter\register-compositions.js")
...
Write-Host "  PHASE 43 COMPLETE!" -ForegroundColor Green
