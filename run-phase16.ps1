# ============================================================================
# Phase 16 - 101 Videos (15 Easter + 30 Emergency Vehicles + 30 Emotions & Feelings + 26 Endangered Species)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase16.ps1
# ============================================================================
...
Write-Host "  PHASE 16: 15 Easter + 30 Emergency Vehicles + 30 Emotions & Feelings + 26 Endangered Species" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "easter\catalog.json"; Name = "Easter"; From = 15; To = 30 },
    @{ Path = "emergency-vehicles\catalog.json"; Name = "Emergency Vehicles"; From = 0; To = 30 },
    @{ Path = "emotions-feelings\catalog.json"; Name = "Emotions & Feelings"; From = 0; To = 30 },
    @{ Path = "endangered-species\catalog.json"; Name = "Endangered Species"; From = 0; To = 26 }
)
...
node (Join-Path $ProjectDir "easter\register-compositions.js")
node (Join-Path $ProjectDir "emergency-vehicles\register-compositions.js")
node (Join-Path $ProjectDir "emotions-feelings\register-compositions.js")
