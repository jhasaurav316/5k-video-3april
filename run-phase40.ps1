# ============================================================================
# Phase 40 - 101 Videos (21 Science Words + 30 Sea Mammals + 30 Shapes + 20 Types of Shoes)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase40.ps1
# ============================================================================
...
Write-Host "  PHASE 40: 21 Science Words + 30 Sea Mammals + 30 Shapes + 20 Types of Shoes" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "science-words\catalog.json"; Name = "Science Words"; From = 9; To = 30 },
    @{ Path = "sea-mammals\catalog.json"; Name = "Sea Mammals"; From = 0; To = 30 },
    @{ Path = "shapes\catalog.json"; Name = "Shapes"; From = 0; To = 30 },
    @{ Path = "shoes-types\catalog.json"; Name = "Types of Shoes"; From = 0; To = 20 }
)
...
node (Join-Path $ProjectDir "sea-mammals\register-compositions.js")
node (Join-Path $ProjectDir "shapes\register-compositions.js")
