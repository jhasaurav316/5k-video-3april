# ============================================================================
# Phase 34 - 101 Videos (27 Park Things + 30 Pasta & Noodles + 30 Pet Animals + 14 Planets & Space Objects)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase34.ps1
# ============================================================================
...
Write-Host "  PHASE 34: 27 Park Things + 30 Pasta & Noodles + 30 Pet Animals + 14 Planets & Space Objects" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "park-things\catalog.json"; Name = "Park Things"; From = 3; To = 30 },
    @{ Path = "pasta\catalog.json"; Name = "Pasta & Noodles"; From = 0; To = 30 },
    @{ Path = "pet-animals\catalog.json"; Name = "Pet Animals"; From = 0; To = 30 },
    @{ Path = "planets\catalog.json"; Name = "Planets & Space Objects"; From = 0; To = 14 }
)
...
node (Join-Path $ProjectDir "pasta\register-compositions.js")
node (Join-Path $ProjectDir "pet-animals\register-compositions.js")
node (Join-Path $ProjectDir "planets\register-compositions.js")
...
Write-Host "  PHASE 34 COMPLETE!" -ForegroundColor Green
