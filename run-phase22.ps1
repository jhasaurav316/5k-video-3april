# ============================================================================
# Phase 22 - 101 Videos (9 Fruits + 30 Furniture + 30 Garage Things + 30 Garden Creatures + 2 Garden Items)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase22.ps1
# ============================================================================
...
Write-Host "  PHASE 22: 9 Fruits + 30 Furniture + 30 Garage Things + 30 Garden Creatures + 2 Garden Items" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "fruits\catalog.json"; Name = "Fruits"; From = 21; To = 30 },
    @{ Path = "furniture\catalog.json"; Name = "Furniture"; From = 0; To = 30 },
    @{ Path = "garage-things\catalog.json"; Name = "Garage Things"; From = 0; To = 30 },
    @{ Path = "garden-creatures\catalog.json"; Name = "Garden Creatures"; From = 0; To = 30 },
    @{ Path = "garden-items\catalog.json"; Name = "Garden Items"; From = 0; To = 2 }
)
...
node (Join-Path $ProjectDir "furniture\register-compositions.js")
node (Join-Path $ProjectDir "garage-things\register-compositions.js")
node (Join-Path $ProjectDir "garden-creatures\register-compositions.js")
node (Join-Path $ProjectDir "garden-items\register-compositions.js")
