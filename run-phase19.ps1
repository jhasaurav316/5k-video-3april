# ============================================================================
# Phase 19 - 101 Videos (12 Famous Landmarks + 30 Farm Animals + 30 Farm Crops + 29 Farm Things)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase19.ps1
# ============================================================================
...
Write-Host "  PHASE 19: 12 Famous Landmarks + 30 Farm Animals + 30 Farm Crops + 29 Farm Things" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "famous-landmarks\catalog.json"; Name = "Famous Landmarks"; From = 18; To = 30 },
    @{ Path = "farm-animals\catalog.json"; Name = "Farm Animals"; From = 0; To = 30 },
    @{ Path = "farm-crops\catalog.json"; Name = "Farm Crops"; From = 0; To = 30 },
    @{ Path = "farm-things\catalog.json"; Name = "Farm Things"; From = 0; To = 29 }
)
...
node (Join-Path $ProjectDir "farm-animals\register-compositions.js")
node (Join-Path $ProjectDir "farm-crops\register-compositions.js")
