# ============================================================================
# Phase 12 - 101 Videos (29 Construction Vehicles + 30 Continents & Countries + 30 Countries + 12 Craft Materials)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase12.ps1
# ============================================================================
...
Write-Host "  PHASE 12: 29 Construction Vehicles + 30 Continents & Countries + 30 Countries + 12 Craft Materials" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "construction-vehicles\catalog.json"; Name = "Construction Vehicles"; From = 1; To = 30 },
    @{ Path = "continents\catalog.json"; Name = "Continents & Countries"; From = 0; To = 30 },
    @{ Path = "countries\catalog.json"; Name = "Countries"; From = 0; To = 30 },
    @{ Path = "craft-materials\catalog.json"; Name = "Craft Materials"; From = 0; To = 12 }
)
...
node (Join-Path $ProjectDir "continents\register-compositions.js")
node (Join-Path $ProjectDir "countries\register-compositions.js")
node (Join-Path $ProjectDir "craft-materials\register-compositions.js")
