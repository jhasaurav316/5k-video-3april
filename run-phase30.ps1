# ============================================================================
# Phase 30 - 101 Videos (11 Math Words + 30 Metals & Elements + 30 Migrating Animals + 30 Months of the Year)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase30.ps1
# ============================================================================
...
Write-Host "  PHASE 30: 11 Math Words + 30 Metals & Elements + 30 Migrating Animals + 30 Months of the Year" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "math-words\catalog.json"; Name = "Math Words"; From = 19; To = 30 },
    @{ Path = "metals\catalog.json"; Name = "Metals & Elements"; From = 0; To = 30 },
    @{ Path = "migrating-animals\catalog.json"; Name = "Migrating Animals"; From = 0; To = 30 },
    @{ Path = "months-year\catalog.json"; Name = "Months of the Year"; From = 0; To = 30 }
)
...
node (Join-Path $ProjectDir "math-words\register-compositions.js")
node (Join-Path $ProjectDir "metals\register-compositions.js")
node (Join-Path $ProjectDir "migrating-animals\register-compositions.js")
node (Join-Path $ProjectDir "months-year\register-compositions.js")
