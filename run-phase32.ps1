# ============================================================================
# Phase 32 - 101 Videos (19 New Year + 30 Nocturnal Animals + 30 Numbers + 22 Nuts & Seeds)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase32.ps1
# ============================================================================
...
Write-Host "  PHASE 32: 19 New Year + 30 Nocturnal Animals + 30 Numbers + 22 Nuts & Seeds" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "new-year\catalog.json"; Name = "New Year"; From = 11; To = 30 },
    @{ Path = "nocturnal-animals\catalog.json"; Name = "Nocturnal Animals"; From = 0; To = 30 },
    @{ Path = "numbers\catalog.json"; Name = "Numbers"; From = 0; To = 30 },
    @{ Path = "nuts-seeds\catalog.json"; Name = "Nuts & Seeds"; From = 0; To = 22 }
)
...
node (Join-Path $ProjectDir "nocturnal-animals\register-compositions.js")
node (Join-Path $ProjectDir "numbers\register-compositions.js")
...
Write-Host "  PHASE 32 COMPLETE!" -ForegroundColor Green
