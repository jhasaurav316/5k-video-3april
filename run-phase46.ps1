# ============================================================================
# Phase 46 - 101 Videos (15 Transportation + 30 Tropical Fish + 30 Types of Boats + 26 Types of Houses)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase46.ps1
# ============================================================================
...
Write-Host "  PHASE 46: 15 Transportation + 30 Tropical Fish + 30 Types of Boats + 26 Types of Houses" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "transportation\catalog.json"; Name = "Transportation"; From = 15; To = 30 },
    @{ Path = "tropical-fish\catalog.json"; Name = "Tropical Fish"; From = 0; To = 30 },
    @{ Path = "types-of-boats\catalog.json"; Name = "Types of Boats"; From = 0; To = 30 },
    @{ Path = "types-of-houses\catalog.json"; Name = "Types of Houses"; From = 0; To = 26 }
)
...
node (Join-Path $ProjectDir "transportation\register-compositions.js")
node (Join-Path $ProjectDir "tropical-fish\register-compositions.js")
node (Join-Path $ProjectDir "types-of-boats\register-compositions.js")
...
Write-Host "  PHASE 46 COMPLETE!" -ForegroundColor Green
