# ============================================================================
# Phase 13 - 101 Videos (18 Craft Materials + 30 Creative Jobs + 30 Dairy Foods + 23 Dance Styles)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase13.ps1
# ============================================================================
...
Write-Host "  PHASE 13: 18 Craft Materials + 30 Creative Jobs + 30 Dairy Foods + 23 Dance Styles" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "craft-materials\catalog.json"; Name = "Craft Materials"; From = 12; To = 30 },
    @{ Path = "creative-jobs\catalog.json"; Name = "Creative Jobs"; From = 0; To = 30 },
    @{ Path = "dairy-foods\catalog.json"; Name = "Dairy Foods"; From = 0; To = 30 },
    @{ Path = "dance-styles\catalog.json"; Name = "Dance Styles"; From = 0; To = 23 }
)
...
node (Join-Path $ProjectDir "creative-jobs\register-compositions.js")
node (Join-Path $ProjectDir "dairy-foods\register-compositions.js")
