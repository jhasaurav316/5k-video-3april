# ============================================================================
# Phase 1 - 101 Videos (30 Airport & Travel + 30 Alphabet Phonics + 30 Animal Homes + 11 Animal Sounds)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase1.ps1
# ============================================================================
...
Write-Host "  PHASE 1: 30 Airport & Travel + 30 Alphabet Phonics + 30 Animal Homes + 11 Animal Sounds" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "airport\catalog.json"; Name = "Airport & Travel"; From = 0; To = 30 },
    @{ Path = "alphabet-phonics\catalog.json"; Name = "Alphabet Phonics"; From = 0; To = 30 },
    @{ Path = "animal-homes\catalog.json"; Name = "Animal Homes"; From = 0; To = 30 },
    @{ Path = "animal-sounds\catalog.json"; Name = "Animal Sounds"; From = 0; To = 11 }
)
...
node (Join-Path $ProjectDir "airport\register-compositions.js")
node (Join-Path $ProjectDir "alphabet-phonics\register-compositions.js")
node (Join-Path $ProjectDir "animal-homes\register-compositions.js")
node (Join-Path $ProjectDir "animal-sounds\register-compositions.js")
