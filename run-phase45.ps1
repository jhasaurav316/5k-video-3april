# ============================================================================
# Phase 45 - 101 Videos (26 Time Words + 30 Workshop Tools + 30 Toys + 15 Transportation)
# ============================================================================
# Batch: 5k-video-3april | Each video: 2:00-2:50 (120-170 seconds)
# Usage: cd C:\test\5k-video-3april && .\run-phase45.ps1
# ============================================================================
...
Write-Host "  PHASE 45: 26 Time Words + 30 Workshop Tools + 30 Toys + 15 Transportation" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "time-words\catalog.json"; Name = "Time Words"; From = 4; To = 30 },
    @{ Path = "tools-workshop\catalog.json"; Name = "Workshop Tools"; From = 0; To = 30 },
    @{ Path = "toys\catalog.json"; Name = "Toys"; From = 0; To = 30 },
    @{ Path = "transportation\catalog.json"; Name = "Transportation"; From = 0; To = 15 }
)
...
node (Join-Path $ProjectDir "tools-workshop\register-compositions.js")
...
Write-Host "  PHASE 45 COMPLETE!" -ForegroundColor Green
